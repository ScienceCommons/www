  ...
  var content = (
    ...
    <div class="container">
      ...
      <div class="wrapper">
          ...
          <div class="answer" style="display: none;">
            To link a replication study to an original study, first add the replication study to an article (as described in the previous two points; this process will soon be substantially streamlined). Then, browse to the article and click the “add replication” icon (<img src={API_ROOT + "images/alpha_images/add-replication-icon.jpg"} />) above the original study to which you want to link a replication study. On the “Add replication” window, search for the article containing the replication study. Then, click on the relevant article and click the “Add replication” button (<img src={API_ROOT+"images/alpha_images/add-replication-button-general.jpg"} />).

                        For example, to add LeBel &amp; Campbell’s (2013, Study 2) as a replication study of Vess’ (2012, Study 1), one would browse to the Vess article (e.g., by searching <a href="https://www.curatescience.org/beta/#/query/Vess%20warm%20thoughts">“Vess warm thoughts”</a>) and then click on the “add replication” icon (<img src={API_ROOT+"images/alpha_images/add-replication-icon.jpg"} />) above Vess’ (2012) Study 1 within the replication table. On the “Add replication” window, locate the LeBel &amp; Campbell (2013) article (by searching “LeBel warmth”), clicking on the article, and then toggling on the appropriate study (i.e., <img src={API_ROOT+"images/alpha_images/add-replication-button-example.jpg"} />). The “Add replication” window can then be closed and you should see the replication study formally linked as a replication of the original study in the replication table.
